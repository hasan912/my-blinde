    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 bg-red-500 pt-32 pb-16 relative flex flex-col lg:flex-row lg:items-center lg:justify-between px-4 sm:px-8 lg:px-16 xl:px-32">
        ...
        <div className="relative flex justify-center lg:justify-end w-full lg:w-auto h-full z-10 lg:py-12">
          ...
          <div className="w-72 sm:w-80 aspect-[9/16] bg-black border-r-16  rounded-2xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] relative border-[8px] border-black overflow-hidden transform lg:scale-110 xl:scale-125 ">
            ...
            <div className="absolute top-3 left-1/2 -translate-x-1/2 w-[15px] h-[15px] bg-black rounded-full z-50"></div>
          </div>
        </div>
